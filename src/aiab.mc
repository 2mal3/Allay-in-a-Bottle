...
## Special effects if the player drinks a allay in a bottle
advancement drink_allay_in_a_bottle {
  "criteria": {
    "requirement": {
  ...
  "rewards": {
    "function": "aiab:drink_allay_in_a_bottle"
  }
}

function drink_allay_in_a_bottle {
  log AllayInABottle debug entity <Drink Allay in a Bottle>
  advancement revoke @s only aiab:drink_allay_in_a_bottle
